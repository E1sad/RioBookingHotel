...
{
    /// <inheritdoc />
    public partial class FirstMigrationAfterThirdGreatPerge : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApartId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DatesApartmentsReserved", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DatesApartmentsReserved_AboutApartments_ApartId",
                        column: x => x.ApartId,
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "ApartId", "EndTime", "StartTime" },
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 4, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 4, 22, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, 3, new DateTime(2024, 3, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 3, 22, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, 2, new DateTime(2024, 4, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 4, 24, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DatesApartmentsReserved_ApartId",
                table: "DatesApartmentsReserved",
                column: "ApartId");
